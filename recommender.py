...
music_df = pd.read_csv(os.path.join(BASE_PATH, "Music Info.csv"))
user_df = pd.read_csv(os.path.join(BASE_PATH, "User Listening History.csv"))
...
feature_matrix = np.load(os.path.join(BASE_PATH, "feature_matrix.npy"))
